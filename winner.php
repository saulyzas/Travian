		...
		<div class="wrapper">
			...
			<div id="mid">
				...
				<div id="content" class="village2" style="font-size: 9pt;">
					...
					threat that had ever faced the free people. Their tireless struggles were rewared at <b></b> on <b><?php echo date('d:M:Y'); ?></b> after a
					...
					<small><i>(By: Multihunter v7.0.0)</i></small></p>
